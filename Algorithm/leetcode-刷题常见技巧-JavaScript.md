...
- [leetcode-刷题常见技巧-JavaScript](#leetcode-%E5%88%B7%E9%A2%98%E5%B8%B8%E8%A7%81%E6%8A%80%E5%B7%A7-javascript)
  ...
  - [3. 快速判断一个整数是奇数还是整数](#3-%E5%BF%AB%E9%80%9F%E5%88%A4%E6%96%AD%E4%B8%80%E4%B8%AA%E6%95%B4%E6%95%B0%E6%98%AF%E5%A5%87%E6%95%B0%E8%BF%98%E6%98%AF%E6%95%B4%E6%95%B0)
...
2. 观察上面的等式，我们可以发现，一个 5 可以带来一个 0，$5^2$（两个因数 5） 可以带来两个 0，$5^3$ （三个因数 5）可以带来 3 个 0，...，那么除了考虑单个因数 5，还要考虑多个因数 5
...
4. 从 1 开始，每隔 5 个数，都会有一个 5 或者 5 的倍数，如下：`5 10 15 20 25 30 35 40 45 50`

5. 按照上面的规律，在 5 的倍数的基础上，每隔 5 个数，还会有 5 的倍数，这些倍数就是多个因数 5，如 25，25 依旧会带来末尾的 0，所以我们还需要进行第二次筛选：`25 50`。数量不够 5 个，因此不能进行第三次筛选了

6. 因此，$50!$ 末尾的 0 的个数是 $10 + 2 = 12$

7. 综上，对于 n!，想获得其末尾的 0 的个数，就是求 n 中 5、25、125、... 的数量的总和。
